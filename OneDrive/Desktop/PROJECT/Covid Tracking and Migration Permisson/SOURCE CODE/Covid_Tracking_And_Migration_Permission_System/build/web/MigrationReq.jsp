  ...
  <div class="wrapper">
    <div id="topnav">
       <ul>
        ...
        <li class="active"><a href="MigrationReq.jsp">Migration Request</a></li>
...
<div id="homecontent">
  <div class="wrapper">
      ...
      <h2>MIGRATE REQUEST</h2>
      <form action="migrateaction.jsp" method="post">
             <table style="margin-bottom: 200px;">
                   
                   
                      
                          <tr><th>USER ID</th><td><input type="text" name="uid" value="<%=id%>" disabled=""></td></tr>
                      <tr><th>MIGRATE FROM</th><td><input type="text" name="mfrom" ></td>
                          <tr> <th>MIGRATE TO</th><td><input type="text" name="mto"></td></tr>
